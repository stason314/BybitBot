...
internal static class RuntimeGridOptionsFactory
{
    ...
    public static GridOptions ToGridOptions(GridBotSettings settings, GridOptions defaults)
    {
        return new GridOptions
        {
            ...
            PairScoreCapitalAllocationEnabled = defaults.PairScoreCapitalAllocationEnabled,
            PairScoreHotMultiplier = defaults.PairScoreHotMultiplier,
            PairScoreGoodMultiplier = defaults.PairScoreGoodMultiplier,
            PairScoreNeutralMultiplier = defaults.PairScoreNeutralMultiplier,
            PairScoreAvoidMultiplier = defaults.PairScoreAvoidMultiplier,
            PairScoreGlobalActiveBuyCapUsdt = defaults.PairScoreGlobalActiveBuyCapUsdt,
            PairScoreMaxHotPairs = defaults.PairScoreMaxHotPairs,
            PairScoreMinBuyScore = defaults.PairScoreMinBuyScore,
            ...
            TopPairActiveCount = defaults.TopPairActiveCount,
            TopPairMinScore = defaults.TopPairMinScore,
            TopPairMinProfitStreak = defaults.TopPairMinProfitStreak,
            NonTopPairMultiplier = defaults.NonTopPairMultiplier,
            NonTopPairProbationMultiplier = defaults.NonTopPairProbationMultiplier,
            TopPairMaxExposureUsdt = defaults.TopPairMaxExposureUsdt,
            TopPairMaxExposurePercent = defaults.TopPairMaxExposurePercent,
            ProfitReinvestEnabled = defaults.ProfitReinvestEnabled,
            ProfitReinvestDailyPnlPercent = defaults.ProfitReinvestDailyPnlPercent,
            ProfitReinvestMultiplier = defaults.ProfitReinvestMultiplier,
            TopPairDipPercent = defaults.TopPairDipPercent,
            TopPairLimitOffsetPercent = defaults.TopPairLimitOffsetPercent,
            ...
            FastProtectiveExitEnabled = defaults.FastProtectiveExitEnabled,
            FastProtectiveExitTriggerPercent = defaults.FastProtectiveExitTriggerPercent,
            FastProtectiveExitFloorPercent = defaults.FastProtectiveExitFloorPercent,
            ReduceOnlyForceExitOnDrawdown = defaults.ReduceOnlyForceExitOnDrawdown,
            ReduceOnlyForceExitDrawdownPercent = defaults.ReduceOnlyForceExitDrawdownPercent,
            ReduceOnlyExitAntiChurnSeconds = defaults.ReduceOnlyExitAntiChurnSeconds,
