  ...
  <script>
    ...
    function buildDiagnostics(data) {
      ...
      const lines = [
        ...
        `turtleCrashShortGateEnabled=${Boolean(result.turtleCrashShortGateEnabled)}`,
        `turtleCrashShortGateReason=${result.turtleCrashShortGateReason || '-'}`,
        `turtleCrashShortCandidateTrades=${Number(result.turtleCrashShortCandidateTrades || 0)}`,
        `turtleCrashShortRegimeTrades=${Number(result.turtleCrashShortRegimeTrades || 0)}`,
        `turtleCrashShortNetPnl=${Number(result.turtleCrashShortNetPnl || 0)}`,
